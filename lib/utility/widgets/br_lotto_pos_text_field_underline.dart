...
class BrLottoPosTextFieldUnderline extends StatefulWidget {
  const BrLottoPosTextFieldUnderline({
    Key? key,
    this.hintText,
    this.label,
    this.inputType,
  ...
  @override
  State<BrLottoPosTextFieldUnderline> createState() =>
      _LongaLottoPosTextFieldUnderlineState();
}

class _LongaLottoPosTextFieldUnderlineState extends State<BrLottoPosTextFieldUnderline> {
  String? selectedDate;
              ...
              style: widget.textStyle ??
                  TextStyle(
                    ...
                    color: widget.enabled == true
                        ? BrLottoPosColor.black_four
                        : widget.hintText != null
                            ? BrLottoPosColor.black_four
                            : BrLottoPosColor.pale_grey_three,
                  ),
              obscureText: widget.obscureText ?? false,
              obscuringCharacter: "*",
              cursorColor: BrLottoPosColor.black_four,
              ...
              decoration: widget.inputDecoration ??
                  InputDecoration(
                    ...
                    errorStyle: TextStyle(
                      color: widget.errorColor ?? BrLottoPosColor.reddish_pink,
                    ),
                    hintMaxLines: 1,
                    ...
                    errorBorder: !widget.underLineType!
                        ? OutlineInputBorder(
                            borderSide: BorderSide(
                              color: widget.borderColor ?? BrLottoPosColor.tomato,
                              width: 1,
                            ),
                            borderRadius: BorderRadius.circular(8),
                          )
                    ...
                    enabledBorder: !widget.underLineType!
                        ? OutlineInputBorder(
                            borderSide: BorderSide(
                              color:
                                  widget.borderColor ?? BrLottoPosColor.black_four,
                              width: 1,
                            ),
                            borderRadius: BorderRadius.circular(8),
                          )
