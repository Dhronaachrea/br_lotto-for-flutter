        ...
        child: Container(
          ...
          child: Text(
            ...
            style: TextStyle(
              ...
              color: textColor ?? BrLottoPosColor.white,
            ),
          ...
          decoration: BoxDecoration(
              ...
              gradient: !isCancelBtn
                  ? LinearGradient(colors: [
                      btnBgColor1 ?? BrLottoPosColor.medium_green,
                      btnBgColor2 ?? BrLottoPosColor.medium_green,
                    ])
                  : null,
              borderRadius: BorderRadius.circular(borderRadius ?? 40),
              border: Border.all(
                  color: borderColor ?? BrLottoPosColor.br_lotto_blue,
