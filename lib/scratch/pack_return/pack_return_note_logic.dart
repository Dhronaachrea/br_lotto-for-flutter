...
import 'package:br_lotto/scratch/pack_return/repository/pack_return_note_repository.dart';
...
class PackReturnNoteLogic {
  static Future<Result<dynamic>> callPackReturnNoteData(BuildContext context, Map<String, dynamic> param, var scratchList) async {
    ...
    dynamic jsonMap = await PackReturnNoteRepository.callPackReturnNoteList(context, param, header,scratchUrl/*scratchList.basePath*/, endUrl);
