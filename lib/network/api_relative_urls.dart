...
const getpaymentReportDataApi = "RMS/v1.0/getPaymentReport";
...
//Scratch
const inventoryFlowReportUrl = "PPL/reports/inventoryFlowReport";
const inventoryReportUrl = "PPL//reports/getInventoryDetailsForRetailer";
const gameDetailsForQuickOrderUrl = "PPL/game/gameDetailsForQuickOrder";
const quickOrderUrl = "PPL/order/quickOrder";
const packActivationUrl = "PPL/inventory/activateBooks";
const gameListUrl = "PPL/game/gameList";
const gameWiseInventoryUrl = "/PPL/inventory/getGameWiseInventory";
const packReturnUrl = "PPL/inventory/getReturnNote";
const packReturnSubmitUrl = "/PPL/inventory/packReturnSubmit";
const dlDetailsUrl = "PPL/inventory/dlDetails";
const bookReceiveUrl = "/PPL/inventory/bookReceive";
const soldTicketUrl = "PPL/sale/soldTickets";
const ticketValidationUrl = "PPL/Winning/verifyWinning";
const ticketClaimUrl = "PPL/Winning/claimWinning";
