import 'package:br_lotto/change_pin/repository/change_pin_repository.dart';
...
class ChangePinLogic {
  static Future<Result<dynamic>> onChangePin(BuildContext context,
      Map<String, dynamic> requestBody, Map<String, String> param) async {
